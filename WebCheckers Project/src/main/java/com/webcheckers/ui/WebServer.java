...
public class WebServer {
  ...
  public static final String SIGNIN_POST_URL = "/signinpost";
  ...
  public void initialize() {
    ...
    get(HOME_URL, new GetHomeRoute(templateEngine, this.gameCenter));

    get(SIGNIN_URL, new GetSignInRoute(templateEngine));
    post(SIGNIN_POST_URL, new PostSignInRoute(templateEngine));

    // Shows the in-progress Game page.
